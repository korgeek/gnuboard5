...
add_stylesheet('<link rel="stylesheet" href="'.$latest_skin_url.'/style.css?ver='.G5_CSS_VER.G5_THEME_URL.'">', 1);
$thumb_width = 138;
$thumb_height = 80;
    ...
    <div class="<?php echo $list_count ? 'latest-sel' : ''; ?>">
        <ul class="item">
            ...
            <li>
                ...
                //if ($list[$i]['comment_cnt'])  echo "<span class=\"lt_cmt\"><span class=\"sound_only\">댓글</span>".$list[$i]['comment_cnt']."</span>";
                echo "</a>";
                ?>
