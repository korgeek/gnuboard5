...
?>
    <div class="top">
        ...
        <h2 id="container_title" title="<?php echo get_text($g5['title']); ?>">
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_cnt">
                    <div class="bo_subject">
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_title">
				...
				<div class="bo_info">
                    ...
                    <span class="bo_view_cate_link">
                        <?php if ($list[$i]['is_notice']) { ?><strong>공지</strong><?php } ?>
                        <?php if ($is_category && $list[$i]['ca_name']) { ?>       
                        <a href="<?php echo $list[$i]['ca_name_href'] ?>"><?php echo $list[$i]['ca_name']; ?></a>
                        <?php } ?>
                    </span>
                    <?php } ?> 
                    <span class="bo_date"><?php echo date("Y-m-d", strtotime($list[$i]['wr_opendatetime'])); ?></span>
