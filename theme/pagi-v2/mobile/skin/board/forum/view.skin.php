...
<ul class="btn_top top btn_bo_user"> 
    <?php if($reply_href || $delete_href || $copy_href || $move_href){?>
    <li>
        ...
        <ul class="more_opt is_view_btn">
            ...
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;"><i class="fa fa-trash" aria-hidden="true"></i> 삭제</a></li><?php } ?>
    ...
    <li><a href="<?php echo $list_href ?>" class="btn_b03 btn"><i class="fa fa-list" aria-hidden="true"></i></a></li>
    <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b03 btn"><i class="fa fa-edit" aria-hidden="true"></i></a></li><?php } ?>
    <?php if ($scrap_href) { ?><li><a href="<?php echo $scrap_href; ?>" class="btn_b03 btn" target="_blank" onclick="win_scrap(this.href); return false;" title="스크랩"><i class="fa fa-thumb-tack" aria-hidden="true"></i><span class="sound_only">스크랩</span></a></li><?php } ?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <div id="bo_v_info">
	        ...
	        <span class="sound_only">작성일</span><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date("Y-m-d H:i", strtotime($view['wr_datetime'])) ?>
	        <span class="sound_only">조회</span><strong><i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?></strong>
	        <span class="sound_only">댓글</span><strong><i class="fa fa-commenting" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?></strong>
	    </div>
    </header>
