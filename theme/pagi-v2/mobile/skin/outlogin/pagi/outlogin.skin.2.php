...
<aside id="ol_after" class="ol">
    ...
    <div id="ol_after_hd">
        ...
        <div id="ol_after_btn">
	        <?php if ($is_admin == 'super' || $is_auth) { ?><a href="<?php echo G5_ADMIN_URL ?>" class="btn_admin"><i class="fi fi-rs-settings"></i><span class="sound_only">관리자</span></a><?php } ?>
	        <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=register_form.php" id="ol_after_edit">정보수정</a>
