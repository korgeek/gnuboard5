...
add_javascript('<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3036178456523392" crossorigin="anonymous"></script>', 0);
?>
...
<header id="hd" class="top">
    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
			...
			<?php echo outlogin('theme/pagi'); // 외부 로그인 ?>
            <ul id="gnb_1dul">
            <?php
...
<div id="wrapper">
        ...
        <div class="ad_mobile_top">
            <?php 
                echo latest_ads('theme/ads_728x', '_ads', 10, 100);
            ?>
        </div>
