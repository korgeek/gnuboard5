        ...
        <h1>
            <?php 
                if(isset($_GET['sca'])) {
                    ...
                    echo htmlspecialchars(strip_tags($board['bo_subject'])); 
                }
             ?>   
    ...
    <div class="story_div">
        ...
        ?>
            <li class="card">
                ...
                ?>
                    <?php 
                     $_news_date = date("Ymd", strtotime($list[$i]['wr_opendatetime']));
                     $_now_date = date_create()->format('Ymd');
                     $_is_future_news = ($_news_date > $_now_date);
                    ?>

                    <h2 class="headline <?php echo $_is_future_news ? "future":"old" ?>">
                    ...
                    <div class="meta">
                        ...
                        <?php } ?>
                        <p class="date"><?php echo date("Y-m-d", strtotime($list[$i]['wr_opendatetime'])); ?></p>
                        <?php if ($is_checkbox) { ?>
                        <div class="adm_input">
