    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
				<li><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><i class="fi fi-rs-list"></i><span class="sound_only">목록</span></a></li>
	            <?php if (false && $reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fi fi-rs-reply-all"></i><span class="sound_only">답변</span></a></li><?php } ?>
                <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn" title="글수정"><i class="fi fi-rs-edit"></i></a></li><?php } ?>

	        	<?php if($update_href || $delete_href || $copy_href || $move_href || $search_href) { ?>
	        	<li>
	        		<button type="button" class="btn_more_opt is_view_btn btn_b01 btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 리스트 옵션</span></button>
		        	<ul class="more_opt is_view_btn"> 
                        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" >쓰기<i class="fi fi-rs-pencil"></i></a></li><?php } ?>
...
;
    ...
    <section id="bo_v_atc">
        ...
        <div class="bo_ads_sample">
            광고예시
            <table>
                <tr style="height: 50px;">
                    <td width="20%"></td>
                    <td width="50%" style="background-color: #f3f3f3;border: 2px solid #009879;">
                        <?php 
                            if($view['file'][0]['file']){
                                echo "<div class=\"bo_ads_sample_img\">\n";
                ...
                <tr style="height: 200px;">
                    <td style="background-color: #f3f3f3;border: 2px solid #009879;">
                        <?php 
                            if($view['file'][1]['file']){
                                echo "<div class=\"bo_ads_sample_img\">\n";
                    ...
                    <td>
                        <?php 
                            if($view['file'][4]['file']){
                                echo "<div class=\"bo_ads_sample_img\">\n";
                                echo get_file_thumbnail($view['file'][4]);
                                echo "</div>\n";
                            }else{
                                echo "모바일";
                            }
        ...
        <!--
        <div>노출우선카테고리: <?php $view['wr_7']; ?></div>
        -->
        <div>광고우선순위: <?php echo empty($view['wr_8']) ?  "미설정" : number_format($view['wr_8']); ?></div>
